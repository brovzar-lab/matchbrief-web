...
import {
  BG, BG_SECONDARY, CARD, BORDER, TEXT, SUBTEXT, ACCENT, ACCENT_DIM, DANGER, MUTED,
  isDemoMode,
} from '../lib/config';
      ...
      >
        ...
        >
          ...
          <View style={styles.hero}>
            ...
            <Text style={styles.appName}>MicroMentor</Text>
            <Text style={styles.tagline}>
              5 minutes a day.{'\n'}The career edge that used to cost $15k/yr.
            </Text>
          </View>

          {/* Demo CTA */}
          <TouchableOpacity style={styles.demoCta} onPress={handleDemoMode}>
            <Text style={styles.demoCtaText}>Continue as Demo User</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  demoCtaText: { fontSize: 16, fontWeight: '700', color: '#000' },
  ...
  primaryBtnText: { fontSize: 15, fontWeight: '600', color: ACCENT },
  googleBtn: {
